    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='user_is_author', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'verbose_name': 'Автор',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_update', models.DateTimeField(auto_now=True, verbose_name='Время обновления')),
                ('response_text', models.TextField(default='There is no response yet.', max_length=3000, verbose_name='Текст отклика')),
                ('status', models.CharField(choices=[('published', 'Опубликовано'), ('draft', 'Черновик')], default='published', max_length=10, verbose_name='Статус отклика')),
                ('lft', models.PositiveIntegerField(editable=False)),
                ('rght', models.PositiveIntegerField(editable=False)),
                ('tree_id', models.PositiveIntegerField(db_index=True, editable=False)),
                ('level', models.PositiveIntegerField(editable=False)),
                ('advert', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='responses', to='adverts.advert', verbose_name='Объявление')),
                ('parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='adverts.response', verbose_name='Родительский отклик')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='advert_response', to=settings.AUTH_USER_MODEL, verbose_name='Автор отклика')),
            ],
            options={
                'verbose_name': 'Отклик',
        ...
        migrations.AddIndex(
            model_name='response',
            index=models.Index(fields=['-time_create', 'time_update', 'status', 'parent'], name='adverts_res_time_cr_d11293_idx'),
        ),
    ]
